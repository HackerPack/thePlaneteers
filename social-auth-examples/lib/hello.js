...
hello.utils.extend( hello, {
	...
	settings : {
		...
		// oauth_proxy   : 'https://2.3.4.5/v1/account/auth/backend/twitter/proxy',
		oauth_proxy   : 'https://api.syncano.io/v1/instances/theplaneteers/user/auth/backend/twitter/proxy',
